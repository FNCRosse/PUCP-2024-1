...
void imprime(Lista tad){
    ...
    while(recorrido != NULL){
        ...
        printf("%c%02d",recorrido->elemento.tipo,recorrido->elemento.numero);        
...
NodoLista *obtener_nodo_anterior(Lista tad, ElementoLista elemento){
    ...
    NodoLista* recorrido = tad.cabeza;
    while(recorrido != NULL && recorrido->elemento.numero<elemento.numero){
        anterior = recorrido;        
        recorrido = recorrido->sig;
    }
    return anterior;    
...
NodoLista* se_encuentra(Lista tad, ElementoLista llave){
    NodoLista* recorrido = tad.cabeza;
    while(recorrido != NULL && recorrido->elemento.numero!=llave.numero){        
        recorrido = recorrido->sig;
    }
    return recorrido;        
}
