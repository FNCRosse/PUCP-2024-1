...
NodoArbol *crear_nuevo_nodo_arbol(ArbolBinario arbol_izq, ElementoArbol elemento, StockArbol stock, ArbolBinario arbol_der){
    NodoArbol* nuevo_nodo = (NodoArbol*)malloc(sizeof(NodoArbol));
    nuevo_nodo->elemento=elemento;
    nuevo_nodo->stock=stock;
    nuevo_nodo->hijo_izq=arbol_izq;
    nuevo_nodo->hijo_der=arbol_der;
    return nuevo_nodo;
}

void plantar_arbol_binario(ArbolBinario *tad, ArbolBinario arbol_izq, ElementoArbol elemento, StockArbol stock, ArbolBinario arbol_der){
    NodoArbol *nuevo_nodo=crear_nuevo_nodo_arbol(arbol_izq, elemento, stock, arbol_der);
    *tad=nuevo_nodo;
}
...
ElementoArbol raiz(ArbolBinario tad){
    if (es_arbol_vacio(tad)){
        printf("No se puede obtener la raÃ­z de un Ã¡rbol vacÃ­o.\n");
        exit(41);
    }
    return tad->elemento;
}
...
ArbolBinario hijo_der(ArbolBinario tad){
    if (es_arbol_vacio(tad)){
        printf("No se puede obtener el hijo derecho de un Ã¡rbol vacÃ­o.\n");
        exit(42);
    }
    return tad->hijo_der;
}
...
ArbolBinario hijo_izq(ArbolBinario tad){
    if (es_arbol_vacio(tad)){
        printf("No se puede obtener el hijo izquierdo de un Ã¡rbol vacÃ­o.\n");
        exit(43);
    }
    return tad->hijo_izq;
}
...
ArbolBinario especular(ArbolBinario tad){
    ...
    if (es_arbol_vacio(tad)){
        ...
        plantar_arbol_binario(&arbol_retorno, hijo_izq, tad->elemento, tad->stock, hijo_der);
    }
...
ArbolBinario copia_arbol_binario(ArbolBinario tad){
    ...
    if (es_arbol_vacio(tad)){
        ...
        plantar_arbol_binario(&arbol_retorno, hijo_izq, tad->elemento, tad->elemento, hijo_der);       
    }
    return arbol_retorno;
}
...
void pre_orden(ArbolBinario tad){
    if (!es_arbol_vacio(tad)){
        printf("(%d %d) ", tad->elemento, tad->stock);
