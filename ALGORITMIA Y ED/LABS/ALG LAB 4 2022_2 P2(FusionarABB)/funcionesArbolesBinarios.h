...
struct NodoArbol * crearNuevoNodoArbol(struct NodoArbol *, Lote, 
                                                          struct NodoArbol *);
void plantarArbolBinario(struct ArbolBinario &, struct NodoArbol *, Lote,
                                                       struct NodoArbol * );
void plantarArbolBinario(struct ArbolBinario &, struct ArbolBinario &, Lote,
                                                struct ArbolBinario &);
Lote raiz(struct NodoArbol * nodo);
