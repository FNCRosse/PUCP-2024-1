...
struct NodoArbol *CrearNuevoNodoArbol(struct NodoArbol *HijoIzq,Guerrero elemento,struct NodoArbol *HijoDer){
...
void PlantarArbolBinario(struct ArbolBinario &arbol,
                                          struct NodoArbol * HijoIzq, Guerrero elemento, struct NodoArbol * HijoDer){
    struct NodoArbol * nuevoNodo = CrearNuevoNodoArbol(HijoIzq,elemento,HijoDer);
    arbol.raiz = nuevoNodo;
}
void PlantarArbolBinario(struct ArbolBinario &arbol,
                                          struct ArbolBinario arbolIzq,Guerrero elemento,struct ArbolBinario arbolDer){
...
void ImprimirNodo(struct NodoArbol *nodo){
    cout<<"("<<nodo->elemento.poder<<"-"<<nodo->elemento.Cantidad<<") ";
}
