...
struct NodoArbol * crearNuevoNodoArbol(struct NodoArbol *, cromo, 
                                                          struct NodoArbol *);
void plantarArbolBinario(struct ArbolBinario &, struct NodoArbol *, cromo,
                                                       struct NodoArbol * );
void plantarArbolBinario(struct ArbolBinario &, struct ArbolBinario &, cromo,
                                                struct ArbolBinario &);
cromo raiz(struct NodoArbol * nodo);
