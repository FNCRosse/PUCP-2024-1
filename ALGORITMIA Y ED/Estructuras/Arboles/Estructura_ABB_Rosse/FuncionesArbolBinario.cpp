...
struct NodoArbol *CrearNuevoNodoArbol(struct NodoArbol *HijoIzq,int elemento,struct NodoArbol *HijoDer){
...
void PlantarArbolBinario(struct ArbolBinario &arbol,
                                          struct NodoArbol * HijoIzq, int elemento, struct NodoArbol * HijoDer){
    struct NodoArbol * nuevoNodo = CrearNuevoNodoArbol(HijoIzq,elemento,HijoDer);
    arbol.raiz = nuevoNodo;
}
void PlantarArbolBinario(struct ArbolBinario &arbol,
                                          struct ArbolBinario arbolIzq,int elemento,struct ArbolBinario arbolDer){
...
void recorreriIterativoEnPostOrden(struct ArbolBinario arbol){
    struct Pila pila,aux;  /*Se usa una pila para acceder a los nodos*/
    construir(pila);
    construir(aux);
    if (not esArbolVacio(arbol)){        
        apilar(pila, arbol.raiz);
