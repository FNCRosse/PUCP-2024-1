 ...
 * Codigo: 20213714
 * Created on 1 de abril de 2024, 20:30
 */
...
int main(int argc, char** argv) {
    ...
    //IMPRESION
    ImprimirRepClientes(CantCli,ArrClientes,"Reporte_Clientes.txt");
    ImprimirRepProductos(CantProd,ArrProductos,"Reporte_Productos.txt");
