...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/p2_lab_10_2023_1.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/p2_lab_10_2023_1.exe: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/p2_lab_10_2023_1 ${OBJECTFILES} ${LDLIBSOPTIONS}
